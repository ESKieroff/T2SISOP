...
# Todos os alvos
all: $(EXEC_TRADUCAO) $(EXEC_CAPACIDADE) $(EXEC_REUTILIZACAO) $(EXEC_TAMANHO_PAGINA)
...
clean:
	rm -f $(SRC_DIR)/*.o $(EXEC_TRADUCAO) $(EXEC_CAPACIDADE) $(EXEC_REUTILIZACAO) $(EXEC_TAMANHO_PAGINA)
